...
import { ReactComponent as enMD } from "./select.en.md";
import { ReactComponent as esMD } from "./select.es.md";
import { ReactComponent as ptMD } from "./select.pt.md";
...
const SelectPage: React.FC = () => {
	...
	return React.createElement(components[language], selectAttr);
};
